...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "Get the Food and don't hit the walls and don't hit yourself";
...
Location loc = new Location(rX,rY);
	...
	private void gameOver() {
		...
		if (playAgain.equalsIgnoreCase("yes")) {
			...
			JOptionPane.showMessageDialog(null, "Please Answer Using Yes or No");
